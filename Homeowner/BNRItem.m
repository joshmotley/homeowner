...
@implementation BNRItem : NSObject




+(instancetype)randomItem{
    // Create and immutable array of three adjectives
    ...
    //Note that NSInteger is not an object, but a definition for "long"
...
-(NSDate *)dateCreated{
    return _dateCreated= [NSDate date];
}
